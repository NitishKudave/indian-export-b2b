      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 shadow-sm p-6 text-center space-y-4">
            ...
            <div className="space-y-1">
              <h3 className="font-bold text-lg text-slate-900 dark:text-white">Rajesh Sharma</h3>
              <p className="text-orange-500 text-xs font-semibold">Chief Logistics Officer</p>
            </div>
            <p className="text-slate-500 text-xs leading-relaxed">
              A cold chain transportation specialist, Rajesh monitors custom clearances, port coordination, and maritime schedules for daily shipments.
            </p>
          </div>
        </div>
      </section>
